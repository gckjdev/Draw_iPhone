...
- (id)initWithFrame:(CGRect)frame delegate:(id<SGFocusImageFrameDelegate>)delegate focusImageItems:(NSArray *)firstItemList
{
...
//        va_list argumentList;
        for(SGFocusImageItem *firstItem in firstItemList){
...
-(void)clickPageImage:(UIButton *)sender{
    UIButton *btn = sender;
    [self.delegate clickActionDelegate:btn.tag];
}
