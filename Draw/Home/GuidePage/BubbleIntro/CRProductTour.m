...
static CGFloat const kSpotlightViewControllerButtonHeight = 40.0f;
static CGFloat const kSpotlightViewControllerButtonWidth = 100.0f;
...
-(UIButton*)buildCloseButtonX:(NSInteger)x
                          ...
                          Tag:(NSInteger)tag
{
    CGFloat buttonOriginX = x;
    CGFloat buttonOriginY = y;
    ...
    [button setTitle:@"I knew it!" forState:UIControlStateNormal];
    button.tag = tag;
...
-(void)onClose:(id)sender
{
    ...
    [self.superview performSelector:@selector(removeFromSuperview) withObject:nil afterDelay:1.0];
