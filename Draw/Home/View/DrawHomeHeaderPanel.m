...
#define SELF_HEIGHT_OPEN ((ISIPAD?800:370)+OPEN_HEIGHT_OFFSET+STATUSBAR_DELTA)
#define SELF_HEIGHT_CLOSE ((ISIPAD?200:100)+HEIGHT_MINUS+STATUSBAR_DELTA)

#define HOLDER_HEIGHT_OPEN ((SELF_HEIGHT_OPEN-VALUE(2))-STATUSBAR_DELTA)
#define HOLDER_HEIGHT_CLOSE ((SELF_HEIGHT_CLOSE-VALUE(2))-STATUSBAR_DELTA)
