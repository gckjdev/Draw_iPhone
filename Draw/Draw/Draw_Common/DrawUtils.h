...
// frame
#define DRAW_VIEW_FRAME_IPAD CGRectMake(19, 106, DRAW_VIEW_WIDTH_IPAD, DRAW_VIEW_HEIGHT_IPAD)
#define DRAW_VIEW_FRAME_IPHONE CGRectMake(8, 46, DRAW_VIEW_WIDTH_IPHONE, DRAW_VIEW_HEIGHT_IPHONE)
