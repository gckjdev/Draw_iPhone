...
- (UIImage *)betActionImage:(UserPosition)position
{
    switch (position) {
        ...
        case UserPositionLeftTop:
            return [[_resService imageByName:@"zjh_bet1" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:24 topCapHeight:0];
            break;
            
        case UserPositionRight:
        case UserPositionRightTop:
            return [[_resService imageByName:@"zjh_bet2" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:10 topCapHeight:0];
            break;
...
- (UIImage *)raiseBetActionImage:(UserPosition)position
{
    switch (position) {
        ...
        case UserPositionLeft:
        case UserPositionLeftTop:
            return [[_resService imageByName:@"zjh_raise_bet1" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:24 topCapHeight:0];
            break;
            
        case UserPositionRight:
        case UserPositionRightTop:
            return [[_resService imageByName:@"zjh_raise_bet2" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:10 topCapHeight:0];
            break;
...
- (UIImage *)checkCardActionImage:(UserPosition)position
{
    switch (position) {
        ...
        case UserPositionLeft:
        case UserPositionLeftTop:
            return [[_resService imageByName:@"zjh_check_card1" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:24 topCapHeight:0];
            break;
            
        case UserPositionRight:
        case UserPositionRightTop:
            return [[_resService imageByName:@"zjh_check_card2" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:10 topCapHeight:0];
            break;
...
- (UIImage *)compareCardActionImage:(UserPosition)position
{
    switch (position) {
        ...
        case UserPositionLeft:
        case UserPositionLeftTop:
            return [[_resService imageByName:@"zjh_compare_card1" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:24 topCapHeight:0];
            break;
            
        case UserPositionRight:
        case UserPositionRightTop:
            return [[_resService imageByName:@"zjh_compare_card2" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:10 topCapHeight:0];
            break;
...
- (UIImage *)foldCardActionImage:(UserPosition)position
{
    switch (position) {
        ...
        case UserPositionLeft:
        case UserPositionLeftTop:
            return [[_resService imageByName:@"zjh_fold_card1" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:24 topCapHeight:0];
            break;
            
        case UserPositionRight:
        case UserPositionRightTop:
            return [[_resService imageByName:@"zjh_fold_card2" inResourcePackage:RESOURCE_PACKAGE_ZJH] stretchableImageWithLeftCapWidth:10 topCapHeight:0];
            break;
