...
#define IPAD_SCALE 2.1
#define DRAW_VEIW_FRAME_IPAD CGRectMake(65, 115, 304 * IPAD_SCALE, 320 * IPAD_SCALE)
#define PICK_PEN_VIEW_IPAD CGRectMake(67, 530 + 20, 302 *IPAD_SCALE, 122*IPAD_SCALE)
#define DRAW_VIEW_WIDTH_IPAD (304 * IPAD_SCALE)
