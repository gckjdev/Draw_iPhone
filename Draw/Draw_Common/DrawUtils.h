...
#define PICK_COLOR_VIEW_IPAD CGRectMake(21, 520, 302 *IPAD_SCALE, 122*IPAD_SCALE)
#define PICK_COLOR_VIEW_IPHONE CGRectMake(8, 250, 302, 122)

#define PICK_BACKGROUND_COLOR_VIEW_IPAD CGRectMake(21, 520, 250 *IPAD_SCALE, 122*IPAD_SCALE)
#define PICK_BACKGROUND_COLOR_VIEW_IPHONE CGRectMake(8, 250, 250, 122)


#define PICK_ERASER_VIEW_IPAD CGRectMake(21, 520, 55 *IPAD_SCALE, 122*IPAD_SCALE)
#define PICK_ERASER_VIEW_IPHONE CGRectMake(7, 250, 55, 122)

#define PICK_PEN_VIEW_IPAD CGRectMake(284, 650, 180 *IPAD_SCALE, 70*IPAD_SCALE )
#define PICK_PEN_VIEW_IPHONE CGRectMake(92, 303, 210, 70)
