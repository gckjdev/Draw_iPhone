...
#define DRAW_VIEW_FRAME_IPHONE (([DeviceDetection screenSize].height == 568) ?CGRectMake(8, 88, 304, 320) : CGRectMake(8, 46, 304, 320))
...
#define PICK_COLOR_VIEW_IPHONE CGRectMake(8, 250, 280, PICK_PEN_VIEW_IPHONE_HEIGHT)

#define PICK_BACKGROUND_COLOR_VIEW_IPAD CGRectMake(131, 520, 302 *IPAD_SCALE - 156, 122*IPAD_SCALE)
#define PICK_BACKGROUND_COLOR_VIEW_IPHONE CGRectMake(54, 250, 232, PICK_PEN_VIEW_IPHONE_HEIGHT)


#define PICK_ERASER_VIEW_IPAD CGRectMake(21, 520, 27 *2, 122*IPAD_SCALE)
#define PICK_ERASER_VIEW_IPHONE CGRectMake(7, 250, 27, PICK_PEN_VIEW_IPHONE_HEIGHT)
