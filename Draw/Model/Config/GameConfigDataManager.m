...
+ (PBAppReward*)drawAppWithRewardAmount:(int)rewardAmount
    ...
    PBAppReward* drawApp = [GameConfigDataManager createAppReward:@"小吉画画"
                                                           ...
                                                           descEn:@"An awesome & fun draw game for you"
                                                            appId:DRAW_APP_ID
                                                       appLogoURL:@"http://43.247.90.45:8080/icon/draw_512.png"
...
+ (PBAppReward*)diceAppWithRewardAmount:(int)rewardAmount
    ...
    PBAppReward* diceApp = [GameConfigDataManager createAppReward:@"夜店大话骰"
                                                           ...
                                                           descEn:@"Online liar dice game"
                                                            appId:DICE_APP_ID
                                                       appLogoURL:@"http://43.247.90.45:8080/icon/dice_114.png"
                                                     rewardAmount:rewardAmount
                                                   rewardCurrency:rewardCurrency];
...
+ (PBAppReward*)xiaojiDrawAppWithRewardAmount:(int)rewardAmount
    ...
    PBAppReward* app = [GameConfigDataManager createAppReward:@"小吉画画"
                                                       ...
                                                       appLogoURL:@"http://43.247.90.45:8080/icon/xiaojidraw_114.png"
                                                     rewardAmount:rewardAmount
                                                   rewardCurrency:rewardCurrency];
...
+ (PBAppReward*)zjhAppWithRewardAmount:(int)rewardAmount
    ...
    PBAppReward* zjhApp = [GameConfigDataManager createAppReward:@"诈金花"
                                                          ...
                                                          descEn:@"Online three card porker game"
                                                           appId:ZJH_APP_ID
                                                      appLogoURL:@"http://43.247.90.45:8080/icon/zjh_512.png"
                                                    rewardAmount:rewardAmount
                                                  rewardCurrency:rewardCurrency];
    return zjhApp;
}
...
+ (PBAppReward*)singAppWithRewardAmount:(int)rewardAmount
    ...
    PBAppReward* zjhApp = [GameConfigDataManager createAppReward:@"小吉大舌头"
                                                          ...
                                                          descEn:@"Funny voice application for sing songs"
                                                           appId:SING_APP_ID
                                                      appLogoURL:@"http://43.247.90.45:8080/icon/song_512.png"
                                                    rewardAmount:rewardAmount
                                                  rewardCurrency:rewardCurrency];
    return zjhApp;
}
...
+ (PBAppReward*)oldDiceAppWithRewardAmount:(int)rewardAmount
    ...
    PBAppReward* diceApp = [GameConfigDataManager createAppReward:@"欢乐大话骰"
                                                       ...
                                                       appLogoURL:@"http://43.247.90.45:8080/icon/dice_old.jpg"
                                                     rewardAmount:rewardAmount
                                                   rewardCurrency:rewardCurrency];
...
+ (PBRewardWall*)limeiWall{
    PBRewardWall* limei = [GameConfigDataManager creatRewardWall:@"力美 推荐应用"
                                                          enName:@"Li Mei"
                                                            ...
                                                            logo:@"http://43.247.90.45:8080/icon/ad_limei.png"];
...
+ (PBRewardWall*)wanpuWall{
    PBRewardWall* wanpu = [GameConfigDataManager creatRewardWall:@"万普 推荐应用"
                                                          enName:@"Wan Pu"
                                                            ...
                                                            logo:@"http://43.247.90.45:8080/icon/ad_wanpu.png"];
    return wanpu;
}
...
+ (PBRewardWall*)youmiWall{
    ...
    PBRewardWall* youmi = [GameConfigDataManager creatRewardWall:@"有米 推荐应用"
                                                          enName:@"You Mi"
                                                            ...
                                                            logo:@"http://43.247.90.45:8080/icon/ad_youmi.png"];
...
+ (PBRewardWall*)aderWall{
    ...
    PBRewardWall* ader = [GameConfigDataManager creatRewardWall:@"人人 推荐应用"
                                                         enName:@"Ren Ren Ader"
                                                           ...
                                                           logo:@"http://43.247.90.45:8080/icon/ad_renren.png"];
