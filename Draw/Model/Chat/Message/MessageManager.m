...
- (id)init
{
    self = [super init];
    if (self) {
        self.messagesInRoom = [NSMutableArray arrayWithObjects:NSLS(@"kPayAttentionToMe"), NSLS(@"kDrawTillDawn"), NSLS(@"kHelloEveryone"), NSLS(@"kDontLeave"), NSLS(@"kFunny"), NSLS(@"kDrawedWhat"), NSLS(@"kHardToGuess"), NSLS(@"kSelfDefine"), nil];
        
        self.messagesInGame = [NSMutableArray arrayWithObjects:NSLS(@"kPayAttentionToMe"), NSLS(@"kDrawTillDawn"), NSLS(@"kWellDone"),NSLS(@"kDontLeave"), NSLS(@"kDontWriteAnswer"), NSLS(@"kDrawedWhat"), NSLS(@"kHardToGuess"), NSLS(@"kGiveAPrompt"), NSLS(@"kSelfDefine"), nil];
    }
