...
typedef enum {
    ...
    GROUP_CREATOR_PERMISSION = ACCESS_GROUP|READ_TOPIC|CREATE_TOPIC|DELETE_TOPIC|REPLY_TOPIC|MARK_TOPIC|TOP_TOPIC|CUSTOM_TITLE|INVITE_USER|HANDLE_REQUEST|ARRANGE_PERMISSION|EXPEL_USER|INVITE_GUEST|CHAT_GROUP|ARRANGE_ADMIN|UPGRADE_GROUP|DISMISSAL_GROUP|EDIT_GROUP|HOLD_CONTEST,
