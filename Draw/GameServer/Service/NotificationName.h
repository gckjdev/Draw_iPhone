...
#define NOTIFICATION_JUMP_TO_ALIPAY_CLIENT      @"NOTIFICATION_JUMP_TO_ALIPAY_CLIENT"
#define NOTIFICATION_SYNC_DATA_FROM_IAP_SERVER  @"NOTIFICATION_SYNC_DATA_FROM_IAP_SERVER"
