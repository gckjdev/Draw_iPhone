...
typedef enum _Game__BetType {
  ...
  GAME__BET_TYPE__BET_TYPE_RAISE = 2
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(GAME__BET_TYPE)
} Game__BetType;
...
struct  _Game__UseItemRequest
{
  ...
  int32_t itemid;
  /*
   * 加时或减时道具，设定的新时长（秒），相对值
   */
  protobuf_c_boolean has_extendtime;
  int32_t extendtime;
  /*
   * 逆道具，返回方向，0: 顺时针；1: 逆时针
   */
  protobuf_c_boolean has_direction;
  int32_t direction;
  /*
   * 使用道具后，下个玩家的ID，用户逆道具或者减时道具
   */
  char *nextplayuserid;
  /*
   * 下一个玩家是否被使用了减时道具
...
struct  _Game__JoinGameRequest
{
  ...
  int32_t ruletype;
  /*
   * force default value to new version
   */
  protobuf_c_boolean has_version;
  int32_t version;
};
...
struct  _Game__NextPlayerStartNotificationRequest
{
  ...
  char *nextplayuserid;
  /*
   * 游戏玩家需要在指定时间内做出响应，0表示使用默认值，－1表示不限制
   */
...
struct  _Game__GameMessage
{
  ...
  int32_t timestamp;
  /*
   * mac=Base64(MD5(messageId+timeStamp+shareKey))
   */
  char *mac;
};
#define GAME__GAME_MESSAGE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&game__game_message__descriptor) \
    , 0, 0, 0,GAME__GAME_RESULT_CODE__SUCCESS, NULL, 0,0ll, 0,0, 0,0, 0,0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0,0, 0,0, 0,0, NULL }
...
#endif  /* PROTOBUF_C_GameMessage_2eproto__INCLUDED */
