...
typedef enum {
  ...
  GameCommandTypeCheckCardNotificationRequest = 803,
  GameCommandTypeCheckCardNotificationResponse = 804,
  GameCommandTypeFoldNotificationRequest = 807,
  GameCommandTypeFoldNotificationResponse = 808,
  GameCommandTypeShowCardNotificationRequest = 809,
  GameCommandTypeShowCardNotificationResponse = 810,
  GameCommandTypeCompareCardNotificationRequest = 811,
  GameCommandTypeCompareCardNotificationResponse = 812,
