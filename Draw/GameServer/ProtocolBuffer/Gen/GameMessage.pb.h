...
@private
  ...
  BOOL hasUrl_:1;
  BOOL hasGroupContest_:1;
  BOOL hasGroupRelation_:1;
  BOOL hasGroup_:1;
...
@property (readonly, retain) PBUserRelationWithGroup* groupRelation;
@property (readonly, retain) NSString* url;
@property (readonly, retain) PBGroupContest* groupContest;
