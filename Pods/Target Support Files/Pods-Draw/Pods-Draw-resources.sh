...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_ROOT}/CKCalendar/Source/resources/left_arrow.png"
  install_resource "${PODS_ROOT}/CKCalendar/Source/resources/left_arrow@2x.png"
  install_resource "${PODS_ROOT}/CKCalendar/Source/resources/right_arrow.png"
  install_resource "${PODS_ROOT}/CKCalendar/Source/resources/right_arrow@2x.png"
  ...
  install_resource "${PODS_ROOT}/PEPhotoCropEditor/Resources/PEPhotoCropEditor.bundle"
